...
function netangelss3_show_file(file,tp)
{
      ...
      shtml+='<br />'
      shtml+='<br />'
      shtml+= '<a href="#" onclick="paste_file()" class="netangels_button">Вставить</a>';
      jQuery('.netangelss3_media_insert_panel').html(shtml);
      jQuery('#alt').unbind('change');
      jQuery('#alt').change(function() {netangelss3_gen_html_code(); } );
      jQuery('#alt').keydown(function() {netangelss3_gen_html_code(); } );
      jQuery('#alt').keyup(function() {netangelss3_gen_html_code(); } );
