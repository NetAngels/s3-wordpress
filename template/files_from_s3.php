...
<p class="submit"><input type="submit" name="submit" id="submit" class="button button-primary send_to_cloud" value="Загрузить из облака" > &nbsp; Удалять в облаке <input id="move_to_cloud" type="checkbox"></p>
<div id="process"></div>
<br />
...
<?php foreach($files as $file) { ?>
       <tr id="" class="type-page status-draft hentry alternate iedit author-self level-0" data-file="<?php  echo $file['name']; ?>">
		<th scope="row" class="check-column">
				<label class="screen-reader-text" for="cb-select-63">Выбрать</label>
		<input id="cb-select-63" class="file" type="checkbox" name="post[]" value="<?php echo $file['name']; ?>">
...
<p class="submit"><input type="submit" name="submit" id="submit" class="button button-primary send_to_cloud" value="Загрузить из облака"></p>